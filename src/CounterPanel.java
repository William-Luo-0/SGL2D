...
public class CounterPanel extends JPanel implements Observer {
    ...
    public CounterPanel(GenericGame game, Boolean c1Enable, Boolean c2Enable, Boolean c3Enable) {
        ...
        counter1 = new JLabel(COUNTER_ONE_TEXT + game.getStringCounter1());        // Sets up Counter 1
        counter2 = new JLabel(COUNTER_TWO_TEXT + game.getStringCounter2());        // Sets up Counter 2
        counter3 = new JLabel(COUNTER_THREE_TEXT + game.getStringCounter3());      // Sets up Counter 3
    ...
    public void update (Observable o, Object arg) {
        ...
        counter2.setText(COUNTER_ONE_TEXT + game.getStringCounter2());         // Updates Counter 2 on change
        counter3.setText(COUNTER_ONE_TEXT + game.getStringCounter3());       // Updates Counter 3 on change
